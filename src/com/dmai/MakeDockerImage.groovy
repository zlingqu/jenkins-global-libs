...
class MakeDockerImage {
    ...
    public void makeImage() {
        ...
        this.script.sh String.format('pwd;tree -L 3;docker-compose build --build-arg VUE_APP_SCENE=%s --build-arg MODEL_VERSION=%s --build-arg FRONTEND_ENV=%s service-docker-build',
